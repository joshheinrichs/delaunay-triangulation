...
public class DelaunayTriangulationAdapter extends ModelAdapter {
    ...
    public DelaunayTriangulationAdapter() {
        ...
        root.getChildren().addAll(background, voronoiEdges, delaunayEdges, delaunayVertexes);
...
//
//        ArrayList<Segment> segments = ((DelaunayTriangulation) model).voronoiEdges;
...
//        }
//
//        segments = ((DelaunayTriangulation) model).getSegments();
...
//        }
//
//        ArrayList<Point> points = ((DelaunayTriangulation) model).getPoints();
